...
private:
    ...
    tref< IRadMemoryPool >       m_pProfileSamplesPool;

    //
    // hierarchy tree for all profile samples
    //
    tref< radProfileSample >     m_pRootProfileSample;

    //
    // last unclosed profile sample
    //
    tref< radProfileSample >     m_pLastUnClosedProfile;

    //
    // last closed profile sample
    //
    tref< radProfileSample >     m_pLastClosedProfile;
