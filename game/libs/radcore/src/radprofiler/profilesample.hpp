...
private:
    ...
    tref< radProfileSample > m_pFirstChildProfileSample;

    tref< radProfileSample >  m_pNextSiblingProfileSample;

    radProfileSample *  m_pPrevSiblingProfileSample;

};

tref< radProfileSample > radProfileSampleCreate( radMemoryAllocator alloc = RADMEMORY_ALLOC_DEFAULT );
