...
public:
    ...
    tref< IDirectInputEffect > m_DirectInputEffect;
    DIEFFECT m_Effect;
    DWORD m_Actuator;
    DWORD m_ForceType;
    ...
    public radRefCount
{
    ...
    )
    {
        ...
        {
            tref< IRadWeakCallbackWrapper > xIWcr;
    ...
    tref< IRadObjectList > m_xIOl_Callbacks;
};
    ...
    public radRefCount
{
    ...
    radControllerDirectInput( LPCDIDEVICEINSTANCE pDidi, tref< IDirectInput8 > xIDirectInput8 )
        :
        radRefCount( 0 ),
        m_InputBufferSize( 0 ),
        m_pInputBuffer( NULL ),
            ...
            if ( m_xIOl_InputPoints != NULL )
            {
                ...
                if ( m_xIDirectInputDevice8 != NULL )
                {
                    ...
                    if ( SUCCEEDED( hr ) )
                    {
                        ...
                        tref< IRadPlatform > xIWin32Platform;
    ...
    tref< IDirectInput8 >       m_xIDirectInput8;
    tref< IDirectInputDevice8 > m_xIDirectInputDevice8;
    tref< IRadObjectList >        m_xIOl_InputPoints;
    tref< IRadObjectList >        m_xIOl_OutputPoints;
    tref< IRadString >            m_xIString_Location;
};
    ...
    public radRefCount
{
    ...
    )
    {
        ...
        if ( m_xIOl_Callbacks != NULL )
        {
            tref< IRadWeakInterfaceWrapper > xIWir;
    ...
    tref< IDirectInput8 >    m_xIDirectInput8;
    tref< IRadObjectList >   m_xIOl_Controllers;
    tref< IRadObjectList >   m_xIOl_Callbacks;
    tref< IRadTimer >        m_xITimer;
    tref< IRadTimerList >    m_xITimerList;
};
