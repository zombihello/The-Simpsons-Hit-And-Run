...
class radPlatform : public IRadPlatform
{
    ...
    tref< IRadObjectList > m_xIOl_MainWindowMessageCallbacks;
    ...
    void LoadIrxModule( const char* pIrxFilenameNoPath, int argSize = 0, char* args = NULL )
    {
        ...
        if ( pIrxFilenameNoPath != NULL )
        {
            ...
            else
            {
                ...
                if( m_IOPMedia != IOPMediaHost )
                {
                    tref< IRadString > xIString_CdPath;
                    radStringCreate( &xIString_CdPath, RADMEMORY_ALLOC_TEMP  );
                    tref< IRadString > xIString_CdFilespec;
                ...
                else
                {
                    ...
                    //
                    tref< IRadString > xIString_HostPath;
                    ...
                    if( loadResult < 0 )
                    {
                        ...
                        //
                        tref< IRadString > xIString_SNHostPath;
    ...
    tref< IRadString >           m_xIString_IrxPath;
    tref< IRadObjectList >       m_xIOl_LoadedIrxModules;
