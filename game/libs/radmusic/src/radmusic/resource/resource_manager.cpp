        ...
        unsigned int start_frame )
{
    ...
    tref< IRadSoundRsdFileDataSource > refIRadSoundRsdFileDataSource =
    ...
    // revisit reading header!
        ...
        tref< IRadSoundAdpcmDecodeStream > refDs =
...
tref< IRadSoundClip > resource_manager_get_clip(
    resource_manager * p_rm,
...
tref< IRadSoundHalDataSource > resource_manager_get_stream(
    resource_manager * p_rm,
    ...
    unsigned int start_frame )
{
    ...
    tref< IRadSoundHalDataSource > ref_IRadSoundHalDataSource;
