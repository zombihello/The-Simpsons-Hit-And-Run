	...
	public radSoundUpdatableObject
{
    ...
    private:
        ...
        tref< IRadMemoryAllocator >        m_xIRadMemoryAllocator;
        tref< IRadSoundHalAudioFormat >    m_xIRadSoundHalAudioFormat;
        tref< IRadSoundMemorySpaceObject > m_xIRadSoundMemorySpaceObject;
    ...
    public radSoundObject
{
    ...
    public:
        ...
        tref< radSoundDataCache >         m_xRadSoundDataCache;
        tref< IRadSoundMemoryDataSource > m_xIRadSoundMemoryDataSource;
