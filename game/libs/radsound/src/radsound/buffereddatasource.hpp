	...
	public radSoundUpdatableObject
{
	...
	private:
		...
		tref< IRadMemoryAllocator > m_xIRadMemoryAllocator_FrameBuffer;
		...
		tref< IRadMemorySpaceCopyRequest > m_xICopyRequest;
		tref< IRadSoundHalDataSourceCallback > m_xIRadSoundHalDataSourceCallback;
		...
		tref< IRadSoundHalAudioFormat > m_xIRadSoundHalAudioFormat;
		tref< IRadSoundHalDataSource >  m_xIRadSoundHalDataSource;
        tref< IRadSoundHalDataSource >  m_xIRadSoundHalDataSource_ReInit;
        tref< IRadString >              m_xIRadString_Name;
};