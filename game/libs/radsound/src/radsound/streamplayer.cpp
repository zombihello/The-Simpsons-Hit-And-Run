...
void radSoundStreamPlayer::AllocateResources( IRadSoundHalAudioFormat * pIRadSoundHalAudioFormat )
{
	...
	tref< IRadMemoryObject > xIRadMemoryObject;
	...
	{
		tref< IRadSoundHalBuffer > xIRadSoundHalBuffer = ::radSoundHalBufferCreate( GetThisAllocator( ) );
...
void radSoundStreamPlayer::ServiceLoad( void )
{
    ...
    tref< IRadSoundHalAudioFormat > xIRadSoundHalAudioFormat = m_xIRadSoundHalVoice->GetBuffer( )->GetFormat( );
