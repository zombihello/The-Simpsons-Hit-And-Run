	...
	public radSoundObject
{
    ...
    private:
        ...
        tref< IDirectSound >            m_xIDirectSound;
        tref< IDirectSoundBuffer >      m_xIDirectSoundBuffer_Primary;
        tref< IDirectSound3DListener >  m_xIDirectSound3DListener;
        tref< IRadSoundHalEffect >      m_refIRadSoundHalEffect[ RSD_SYSTEM_MAX_AUX_SENDS ];
