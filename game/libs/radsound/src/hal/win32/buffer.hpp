	...
	public radSoundObject
{
	public:
        ...
        struct BufferData
        {
            tref< IDirectSoundBuffer > m_refIDirectSoundBuffer;
	...
	private:
		...
		static tref< IRadMemoryPool >    s_refIRadMemoryPool;
		tref< IRadSoundHalAudioFormat >	m_refIRadSoundHalAudioFormat;
		tref< IRadMemoryObject >			m_refIRadMemoryObject;
        tref< IRadSoundHalBufferLoadCallback > m_refIRadSoundHalBufferLoadCallback;
