	...
	public radSoundObject
{
	...
	private:
		...
		tref< radSoundHalBufferWin >		m_xRadSoundHalBufferWin;
		tref< IRadSoundHalAudioFormat >	m_xIRadSoundHalAudioFormat;

        radSoundHalBufferWin::BufferData * m_pBufferData;
        tref< IDirectSound3DBuffer >		m_xIDirectSound3dBuffer;
		tref< IDirectSoundBuffer >		m_xIDirectSoundBuffer;

		tref< radSoundHalPositionalGroup > m_xRadSoundHalPositionalGroup;
};
