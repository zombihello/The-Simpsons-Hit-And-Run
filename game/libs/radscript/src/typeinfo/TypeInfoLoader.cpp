	...
	public radRefCount
{
    ...
    tref< IRadTypeInfoSystem > m_xIRadTypeInfoSystem;

	tref< IRadFile >        m_pIRadFile;
    ...
    virtual void OnFileOperationsComplete( void* pUserData )
    {
        ...
        tref< IRadTypeInfo > xIRadTypeInfo;
				...
				while ( (char *)p < m_pTypeInfoMemory + m_TypeInfoMemorySize )
				{
					...
					switch (token)
					{
						...
						case ParserConst::TOK_METHOD:
						{
                            ...
                            // Arguments list
                            //
                            tref< IRadTypeInfoMethod > xIRadTypeInfoMethod ( ::radTypeInfoMethodCreate( m_TypeInfoAllocator ) );
                            ...
                            tref< IRadTypeInfoParam > pRTIReturnParam( ::radTypeInfoParamCreate( m_TypeInfoAllocator ) );
                            ...
                            for ( unsigned int i = 0; i < numParams; i++ )
                            {
                                ...
                                tref< IRadTypeInfoParam > pRTIParam( ::radTypeInfoParamCreate( m_TypeInfoAllocator ) );
                        ...
                        case ParserConst::TOK_ENUM:
						{
                            ...
                            tref< IRadTypeInfoEnum > xIRadTypeInfoEnum;
                            ...
                            for (unsigned int i = 0; i < numEnum; i++)
                            {
                                ...
                                if (m_bLoadEnum)
                                {
                                    tref< IRadTypeInfoIntLiteral > pRTIIntLiteral( ::radTypeInfoIntLiteralCreate( m_TypeInfoAllocator ) );
