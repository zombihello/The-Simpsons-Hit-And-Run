...
public:
    ...
    static tref< IRadTypeInfoSystem > s_pTheTypeInfoSystem;
    static tref< IRadString > ms_pEmptyString;
    ...
    tref< IRadObjectList >   m_xIOl_TypeInfo;
    tref< IRadObjectList >   m_xIOl_Enum;

    // string table used for all typeinfo string in typeinfo system
    tref< radObjectBTree >  m_xIOt_StringTable;
...
private:
    ...
    tref< IRadObjectList >   m_xIOl_Methods;
    tref< IRadObjectList >   m_xIOl_Enums;
};
...
private:
    ...
    tref< IRadObjectList >       m_lstIntLiteralsPtr;
};
...
private:
    ...
    tref< IRadTypeInfoParam >    m_pReturnParam;

    tref< IRadObjectList >       m_lstParamsPtr;
...
inline void IRadTypeInfoSystem::AddString( unsigned int uHashValue, const char * szString )
{
    if ( m_bLoadString )
    {
        ...
        tref< IRadString > pFindString = static_cast< IRadString * >( m_xIOt_StringTable->FindObject( uHashValue ) );
...
inline int IRadTypeInfoEnum::GetValueByName( const char * pName )
{
    ...
    tref< IRadTypeInfoIntLiteral > pIntLiteral;
...
{
    tref< IRadTypeInfoEnum > pTypeInfoEnum = NULL;
...
{
    tref< IRadTypeInfoLoader > xIRadTypeInfoLoader( ::radTypeInfoLoaderCreate( RADMEMORY_ALLOC_TEMP ) );
...
inline IRadTypeInfo * IRadTypeInfoSystem::GetTypeInfo( IRefCount * pIRefCount )
{
    ...
    if ( pIRefCount != NULL )
    {
        ...
        tref< IRadTypeInfo > pIRadTypeInfo = NULL;
...
{
    tref< IRadTypeInfo > xITi = GetTypeInfo( pIRefCount );
