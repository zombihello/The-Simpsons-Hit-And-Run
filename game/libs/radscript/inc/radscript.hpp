    ...
    public radRefCount
{
    ...
    char *                  m_pFileMemory;
    tref< IRadNameSpace >    m_xIRadNameSpace_Context;

    tref< IRadFile >         m_xIRadFile;
    ...
    tref< IRefCount >        m_xCurrObjectInstance;
    tref< IRadTypeInfo >     m_xCurrObjectTypeInfo;
};
...
{
	tref< IRadTypeInfoMethod > xIRadTypeInfoMethod;
    ...
    tref< IRadTypeInfoParam > pIRadTypeInfoParam;
